...
import {IonCard, IonItem, IonCardContent, IonList, IonImg, IonLabel, IonIcon, IonText, IonButton} from '@ionic/react'
import { IonThumbnail } from '@ionic/react'
import {chevronUpCircleOutline, timeOutline, personCircleOutline, caretUp} from 'ionicons/icons'
                    ...
                    <IonItem>
                        ...
                        <IonLabel>
                            ...
                            <p style={{alignItems: "center", fontSize: "0.8rem", fontWeight: "normal"}}>
                                <IonIcon icon={chevronUpCircleOutline} style={{verticalAlign:"middle"}}/>{" "}<IonText style={{verticalAlign:"middle"}}>{product.voteCount} points</IonText>{" | "}
